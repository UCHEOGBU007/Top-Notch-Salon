...
//       .from("Top Notch Reservation Table")
//       .insert([reservation]);
//     if (error) {
//       setFormError(
...
//             <img src="/Formpensil2.jpg" alt="Booking form illustration" />
//           </div> */}
//           <form
...
//             {formError && (
//               <p style={{ color: "red", fontSize: "bolder" }}>{formError}</p>
//             )}
//           </form>
//         </div>
