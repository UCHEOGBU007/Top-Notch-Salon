...
const Reservation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (error) {
      console.error("Supabase error:", error); // ✅ Debugging aid
      setFormError(
    ...
    <>
      <section className={Style.container}>
        <div className={Style.header}>
          <img src="/ABOUTBODY.jpg" alt="Salon Header" loading="lazy" />
        </div>
        ...
        <div className={Style.illustrationcontainer}>
          <form onSubmit={handleSubmit} role="form" autoComplete="off">
            <fieldset>
              ...
              <label htmlFor="occasion">Services:</label>
              <select
                id="occasion"
                name="occasion"
                required
              ...
              >
                ...
                <option value="Hair coloring">Hair coloring & Treatment</option>
                <option value="Dreadlocks">Dreadlocks</option>
                <option value="Braids">Braids </option>
                <option value="Pedicure">Pedicure</option>
                <option value="Manicure">Manicure</option>
                <option value="Kids Hair cutting">Kids Hair cutting</option>
              </select>
